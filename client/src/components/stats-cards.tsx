  ...
  const cards = [
    {
      ...
      change: `${stats?.totalTeams || 0} teams`,
      changeText: "across disciplines",
      changeColor: "text-success-600",
    },
    {
      title: "Checked In",
      value: (stats?.checkedInCount || 0).toLocaleString(),
      icon: CheckCircle,
      iconBg: "bg-success-100",
      iconColor: "text-success-600",
      change: stats?.totalParticipants ? Math.round(((stats?.checkedInCount || 0) / stats.totalParticipants) * 100) + "%" : "0%",
      changeText: "of total",
    ...
    },
    {
      ...
      changeText: `across ${stats?.totalHotels || 0} hotels`,
      changeColor: "text-gray-500",
    },
    {
